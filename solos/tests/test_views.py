...
class IndexViewTestCase(TestCase):
    ...
    def test_index_view_returns_solos(self):
        """
        Test that index view will attempt to return solos if query parameters exist
        """
...
class SoloViewTestCase(TestCase):
    ...
    def test_basic(self):
        """
        Test that the solo view returns a 200, uses the correct template and has the
        correct context
        """
